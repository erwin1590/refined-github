...
import {getUsernameForFilters} from '../libs/utils';
...
function init(): void {
	...
	const links = [
		['Commented', `${typeName} you’ve commented on`, `commenter:${getUsernameForFilters()}`],
		['Yours', `${typeName} on your repos`, `user:${getUsernameForFilters()}`]
	];
